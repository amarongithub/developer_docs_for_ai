...
> **Note:** This is a compiled version of the documentation, generated for reference purposes.

This document contains the complete documentation, organized by sections and topics.
Each section maintains its original structure while being part of a single, searchable document.
...
- [Build and deploy](#build-and-deploy)
  ...
  - [Adapters](#adapters)
  - [Zero-config deployments](#zero-config-deployments)
...
- [Appendix](#appendix)
  ...
  - [Migrating to SvelteKit v2](#migrating-to-sveltekit-v2)
  - [Migrating from Sapper](#migrating-from-sapper)
  - [Additional resources](#additional-resources)
  - [Glossary](#glossary)
- [Reference](#reference)
  - [@sveltejs/kit](#sveltejskit)
  - [@sveltejs/kit/hooks](#sveltejskithooks)
  - [@sveltejs/kit/node](#sveltejskitnode)
  - [@sveltejs/kit/node/polyfills](#sveltejskitnodepolyfills)
  - [@sveltejs/kit/vite](#sveltejskitvite)
...
[See the imagetools repo for the full list of directives(#httpsgithubcomjonaskruckenbergimagetoolsblobmaindocsdirectives).
...
Please see [the Svelte FAQ](../svelte/faq) and [`vite-plugin-svelte` FAQ(#httpsgithubcomsveltejsvite-plugin-svelteblobmaindocsfaq) as well for the answers to questions deriving from those libraries.
...
Including [`vitePreprocess`(#httpsgithubcomsveltejsvite-plugin-svelteblobmaindocspreprocess) in your project will allow you to use the various flavors of JS and CSS that Vite supports: TypeScript, PostCSS, SCSS, Less, Stylus, and SugarSS. If you set your project up with TypeScript it will be included by default:
...
You will need to install `svelte-preprocess` with `npm install --save-dev svelte-preprocess` and [add it to your `svelte.config.js`](https://github.com/sveltejs/svelte-preprocess/blob/main/docs/usage.md#with-svelte-config). After that, you will often need to [install the corresponding library(#httpsgithubcomsveltejssvelte-preprocessblobmaindocsgetting-started) such as `npm install -D sass` or `npm install -D less`.
...
The [Svelte FAQ](../svelte/faq) and [`vite-plugin-svelte` FAQ(#httpsgithubcomsveltejsvite-plugin-svelteblobmaindocsfaq) may also be helpful for questions deriving from those libraries.
